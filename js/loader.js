...
define('fuelux/datepicker',['require','jquery'],function (require) {
	...
	var Datepicker = function (element, options) {
		...
		this.options.monthNames    = this.options.monthNames || [ "Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ago", "Sep", "Oct", "Nov", "Dic" ];
		this.options.weekdays      = this.options.weekdays || [ "Do", "Lu", "Ma", "Mi", "Ju", "Vi", "Sa"];
